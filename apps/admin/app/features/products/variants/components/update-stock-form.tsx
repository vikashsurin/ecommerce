...
export function UpdateStockForm({ productId, variantId, stockValue, setOpen }: { productId: number; variantId: number; stockValue?: number; setOpen: React.Dispatch<React.SetStateAction<boolean>> }) {
