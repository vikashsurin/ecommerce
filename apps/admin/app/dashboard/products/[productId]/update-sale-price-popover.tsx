import { UpdateSalePriceForm } from "@/app/features/products/variants/components/update-sale-price-form";
...
export default function UpdateSalePricePopover({ productId, variantId,price, salePrice }: {
  productId: number;
  variantId: number;
  price: number;
      ...
      <Popover open={open} onOpenChange={setOpen}>
        ...
        <PopoverContent>
          <PopoverHeader>
            ...
            <PopoverDescription>Change the sale price for this variant.</PopoverDescription>
          </PopoverHeader>
